...
const NavBar = () => {
    return(
    <div>
        <div className="flex justify-between items-center bg-gray-50 shadow-sm p-4 ps-10">
            <a href="/home"><img src={masmoo3} className="size-8"/></a>
            <Searchkit/>
            <div className="flex justify-center items-center space-x-4">
                <PlayBack/>
                <div className="flex justify-between items-center space-x-10 pe-10 shrink-0">
