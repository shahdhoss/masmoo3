...
const SearchCard = () => {
    ...
    return (
        <div className="border-3 border-[#00332c] flex justify-center items-center p-4  rounded-lg w-80 h-64 space-x-4 bg-gray-50 shadow-md">
            <div className="relative h-48 bg-gray-900 w-28">
                {/* Bookmark Image */}
